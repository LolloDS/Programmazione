# -*- coding: utf-8 -*-
"""
Created on Fri Nov 17 08:59:07 2023
...
def intersezione_liste( a, b ):
    '''
    input: a, b: liste
    output: lista c contenenete gli elementi che sono sia in a che in b, senza ripetizione
    '''
...
def intersezione_liste( a, b ):
    ...
    for e in a:  # n iterazioni
        if e in b and not e in c:  # O(1) + O(1)
            c[e] = None  # O(1)
            
    c = [k for k in d]  # O( min(n, m) )
